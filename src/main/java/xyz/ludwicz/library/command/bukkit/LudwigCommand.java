...
public class LudwigCommand extends Command implements PluginIdentifiableCommand {

    protected CommandNode node;

    private final JavaPlugin owningPlugin;

    public LudwigCommand(CommandNode node, JavaPlugin plugin) {
    ...
    public boolean execute(final CommandSender sender, String label, String[] args) {
        ...
        if (executionNode.canUse(sender)) {
                    ...
                    public void run() {
                        block3:
                        {
                            try {
                                ...
                                LudwigCommand.this.sendStackTrace(sender, ex);
                            }
                        }
                    }
            ...
            sender.sendMessage(LudwigCommandHandler.getConfig().getNoPermissionMessage());
        }
        return true;
    }
    ...
    public List<String> tabComplete(CommandSender sender, String cmdLine) {
        ...
        try {
            ...
            if (realNode.getParameters() != null) {
                ...
                parameterType = LudwigCommandHandler.getParameterType(data.getType());
